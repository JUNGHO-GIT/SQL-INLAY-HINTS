...
// ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――-
export const modal = (type: `info` | `warn` | `error`, value: string): PromiseLike<string | undefined> => {
  const text = `[${MAIN}] ${value}`;
  const options = {
    modal: true,
  };

  const result = type === `info` ? vscode.window.showInformationMessage(text, options) : type === `warn` ? vscode.window.showWarningMessage(text, options) : vscode.window.showErrorMessage(text, options);
